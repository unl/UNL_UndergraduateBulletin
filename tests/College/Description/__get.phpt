...
<p class="numbered-list">3. A deficiency of the second year of algebra can be removed by taking <a class="course" href="/workspace/UNL_UndergraduateBulletin/www/courses/MATH/95C">MATH 95C</a> (not for college credit) or <a class="course" href="/workspace/UNL_UndergraduateBulletin/www/courses/MATH/100A">MATH 100A</a> (may be taken for college credit but does not apply toward graduation).</p>
<p class="numbered-list">4. A student whose deficiency is the additional (fourth) year of mathematics that builds on algebra must successfully complete <a class="course" href="/workspace/UNL_UndergraduateBulletin/www/courses/MATH/101">MATH 101</a>, <a class="course" href="/workspace/UNL_UndergraduateBulletin/www/courses/MATH/102">102</a>, or <a class="course" href="/workspace/UNL_UndergraduateBulletin/www/courses/MATH/103">103</a>, or an equivalent course at another institution.</p>
