...
<p class="numbered-list">4. A student whose deficiency is the additional (fourth) year of mathematics that builds on algebra must successfully complete <a class="course" href="'.UNL_UndergraduateBulletin_Controller::getURL().'courses/MATH/101">MATH 101</a>, <a class="course" href="'.UNL_UndergraduateBulletin_Controller::getURL().'courses/MATH/102">102</a>, or <a class="course" href="'.UNL_UndergraduateBulletin_Controller::getURL().'courses/MATH/103">103</a>, or an equivalent course at another institution.</p>
