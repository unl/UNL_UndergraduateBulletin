--TEST--
UNL_UndergraduateBulletin_Major::minorAvailable
--FILE--
<?php
require dirname(__FILE__) . '/../test_framework.php.inc';

$major = UNL_UndergraduateBulletin_Major::getByName('Mechanical Engineering');
$test->assertFalse($major->minorAvailable(), 'minor available');

$major = UNL_UndergraduateBulletin_Major::getByName('Accounting');
$test->assertTrue($major->minorAvailable(), 'minor available');
