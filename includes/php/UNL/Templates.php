...
class UNL_Templates extends UNL_DWT
{
    ...
    {
        if ('/Users/bbieber/Documents/workspace/UNL_UndergraduateBulletin/includes/data' != '@DATA_DIR'.'@') {
            // pear/pyrus installation
            return '/Users/bbieber/Documents/workspace/UNL_UndergraduateBulletin/includes/data/UNL_Templates/data/';
        }
