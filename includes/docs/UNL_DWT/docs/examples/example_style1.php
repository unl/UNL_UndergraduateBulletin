<?php
/**
 * This example uses the DWT object generated by: '/usr/local/bin/php /Users/bbieber/Documents/workspace/UNL_UndergraduateBulletin/includes/php/UNL/DWT/createTemplates.php /Users/bbieber/Documents/workspace/UNL_UndergraduateBulletin/includes/docs/UNL_DWT/docs/examples/example.ini'
 * 
 */
...
if ('/Users/bbieber/Documents/workspace/UNL_UndergraduateBulletin/includes/data' == '@'.'DATA_DIR@') {
    ...
    $configfile = '/Users/bbieber/Documents/workspace/UNL_UndergraduateBulletin/includes/docs/UNL_DWT/docs/examples/example.ini';
}
...
$page->content .= "<p>And the command used to create the template classes:<pre><code>/usr/local/bin/php /Users/bbieber/Documents/workspace/UNL_UndergraduateBulletin/includes/php/UNL/DWT/createTemplates.php /Users/bbieber/Documents/workspace/UNL_UndergraduateBulletin/includes/docs/UNL_DWT/docs/examples/example.ini</code></pre></p>";
