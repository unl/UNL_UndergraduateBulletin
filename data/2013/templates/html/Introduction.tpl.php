                ...
                <li class="wdn-col">
                    <div>
                        <a href="college/Agricultural+Sciences+%26+Natural+Resources" class="header-underlay">
                            <img src="<?php echo $baseURL ?>images/thumb_casnr.jpg" alt="College of Agricultural Sciences &amp; Natural Resources" />
                ...
                <li class="wdn-col">
                    <div>
                        <a href="college/Architecture" class="header-underlay">
                            <img src="<?php echo $baseURL ?>images/thumb_arc.jpg" alt="College of Architecture" />
                ...
                <li class="wdn-col">
                    <div>
                        <a href="college/Arts+%26+Sciences" class="header-underlay">
                            <img src="<?php echo $baseURL ?>images/thumb_cas.jpg" alt="College of Arts &amp; Sciences" />
                ...
                <li class="wdn-col">
                    <div>
                        <a href="college/Business+Administration" class="header-underlay">
                            <img src="<?php echo $baseURL ?>images/thumb_cba.jpg" alt="College of Business Administration" />
                ...
                <li class="wdn-col">
                    <div>
                        <a href="college/Education+%26+Human+Sciences" class="header-underlay">
                            <img src="<?php echo $baseURL ?>images/thumb_ehs.jpg" alt="College of Education &amp; Human Sciences" />
                ...
                <li class="wdn-col">
                    <div>
                        <a href="college/Engineering" class="header-underlay">
                            <img src="<?php echo $baseURL ?>images/thumb_eng.jpg" alt="College of Engineering" />
                ...
                <li class="wdn-col">
                    <div>
                        <a href="college/Fine+%26+Performing+Arts" class="header-underlay">
                            <img src="<?php echo $baseURL ?>images/thumb_fpa.jpg" alt="Hixson-Lied College of Fine &amp; Performing Arts" />
                ...
                <li class="wdn-col">
                    <div>
                        <a href="college/Journalism+%26+Mass+Communications" class="header-underlay">
                            <img src="<?php echo $baseURL ?>images/thumb_jmc.jpg" alt="College of Journalism &amp; Mass Communications" />
        ...
        <div class="bp2-wdn-col-one-fourth">
            <div class="separator-box" style="margin-top: 59px;">
                <a href="college/Exploratory+%26+Pre-Professional+Advising+Center">
                    <img src="<?php echo $baseURL ?>images/thumb_ec.jpg" alt="The Explore Center" />
                </a>
