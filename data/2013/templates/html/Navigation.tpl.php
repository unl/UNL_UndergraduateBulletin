...
<ul>
    <li><a href="<?php echo $url; ?>major/">Majors</a>
        <ul>
            <li><a href="<?php echo $url; ?>major/search">Search for a Major</a></li>
        </ul>
    </li>
    ...
    <li><a href="<?php echo $url; ?>general">Academic Policies</a>
        <ul>
            ...
            <li><a href="http://stuafs.unl.edu/dos/code">Student Code of Conduct</a></li>
        </ul>
    </li>
    <li><a href="<?php echo $url; ?>college/">Academic Colleges</a>
        <ul>
            <li><a href="<?php echo $url; ?>college/Agricultural+Sciences+%26+Natural+Resources">Agricultural Sciences &amp; Natural Resources</a></li>
            <li><a href="<?php echo $url; ?>college/Architecture">Architecture</a></li>
            <li><a href="<?php echo $url; ?>college/Arts+%26+Sciences">Arts &amp; Sciences</a></li>
            <li><a href="<?php echo $url; ?>college/Business+Administration">Business Administration</a></li>
            <li><a href="<?php echo $url; ?>college/Education+%26+Human+Sciences">Education &amp; Human Sciences</a></li>
            <li><a href="<?php echo $url; ?>college/Engineering">Engineering</a></li>
            <li><a href="<?php echo $url; ?>college/Fine+%26+Performing+Arts">Hixson-Lied College of Fine &amp; Performing Arts</a></li>
            <li><a href="<?php echo $url; ?>college/Journalism+%26+Mass+Communications">Journalism &amp; Mass Communications</a></li>
        </ul>
    </li>
    <li>
        <a href="<?php echo $url; ?>college/Exploratory+%26+Pre-Professional+Advising+Center">Explore Center</a>
        <ul>
            <li><a href="<?php echo $url; ?>college/Exploratory+%26+Pre-Professional+Advising+Center#undecided-students">Undecided Students</a></li>
            <li><a href="<?php echo $url; ?>college/Exploratory+%26+Pre-Professional+Advising+Center#pre-professional-students">Pre-Professional Programs</a></li>
        </ul>
    </li>
