...
<ul>
    ...
    <li><a href="#">Honors Programs</a>
        <ul>
            <li><a href="<?php echo $url; ?>college/Office+of+Undergraduate+Studies#university-honors-program-">NU Honors Program</a></li>
    ...
    <li><a href="<?php echo $url; ?>college/">Other Academic Units</a>
        <ul>
            <li><a href="<?php echo $url; ?>college/Office+of+Undergraduate+Studies">Office of Undergraduate Studies</a></li>
